...
public abstract class Interactive implements Configured {
    protected static final ConcurrentMap<String, Interactive> interactives = HuntBotApp.getBot().getInteractives();
    ...
    protected Interactive(String interactiveID, String guildID) {
        this(interactiveID, guildID, CONSTANTS.getInteractiveIdle(), CONSTANTS.getInteractiveHardStop());
    }
